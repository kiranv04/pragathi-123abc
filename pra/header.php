                    ...
                    <div class="navbar-nav mx-auto py-0 pl-50">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                <a href="" class="dropdown-item">Office Automation</a>
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                ...
                                <a href="software-testing.php" class="dropdown-item">Software Testing</a>
                            </div>
                        </div>
                        <!-- <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Products</a>
                            <div class="dropdown-menu m-0">
                                <a href="404.php" class="dropdown-item">Websites</a>
                                <a href="team.php" class="dropdown-item">School Management System (SMS)</a>
                                <a href="testimonial.php" class="dropdown-item">Hospital Management System (HMS)</a>
                            </div>
                        </div> -->
