...
<div class="container-fluid bg-primary text-light footer wow fadeIn" data-wow-delay="0.1s">
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-5 text-center text-md-start mb-5 mb-md-0 d-flex align-items-center">
            <h5 class="section-title text-white h6 mx-auto">© 2023 Pragathi Computer Education. All Rights Reserved.</h5>
        </div>
    </div>
</div>
<!-- Footer End -->
